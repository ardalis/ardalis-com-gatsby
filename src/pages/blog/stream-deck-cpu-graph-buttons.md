...
![stream deck cpu network graph buttons](/static/img/stream-deck-hwinfo-buttons.jpeg)
...
![stream deck hwinfo extension](/static/img/stream-deck-hwinfo-extension.jpg)
...
![hwinfo sensor status](/static/img/hwinfo64-sensor-status.png)
